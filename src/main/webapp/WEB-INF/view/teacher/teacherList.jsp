            ...
            <tr>
                ...
                <td colspan="1">
                    <select id="add_clazz_name" style="width: 200px; height: 30px;" class="easyui-combobox"
                            name="clazz_name" data-options="required:true, missingMessage:'请选择所属班级~'">
                        <c:forEach items="${clazzList}" var="clazz">
                            <option value="${clazz.name}">${clazz.name}</option>
                        </c:forEach>
                    </select>
            ...
            <tr>
                ...
                <td colspan="1">
                    <input id="add_tno" style="width: 200px; height: 30px;" class="easyui-textbox"
                           type="text" name="tno" data-options="required:true, missingMessage:'请填写工号~'"/>
                </td>
            </tr>
            <tr>
                <td>密码</td>
                <td colspan="1">
                    <input id="add_password" style="width: 200px; height: 30px;" class="easyui-textbox"
                           type="password" name="password" data-options="required:true, missingMessage:'请填写自定义密码~'"/>
                </td>
            </tr>
            <tr>
                <td>邮箱</td>
