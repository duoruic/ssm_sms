...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/h-ui/lib/jquery/1.9.1/jquery.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/h-ui/lib/jquery/1.9.1/jquery.min.js"></script>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#vcodeImg").click(function () {
                this.src = "getVerifyCodeImage?t=" + new Date().getTime();
            });
            //登录按钮事件
    ...
    <div id="loginform" class="loginBox">
        <form id="form" class="form form-horizontal" method="post" action="#">
            ...
            <div class="row cl">
                <label class="form-label col-3"><i class="Hui-iconfont">&#xe647;</i></label>
                <div class="formControls col-8">
                    <input id="VerifyCode" class="input-text radius size-L" name="VerifyCode" type="text"
                           placeholder="验证码"
                           style="width: 200px;">
                    <img title="点击图片切换验证码" id="vcodeImg" src="getVerifyCodeImage" alt="#">
                </div>
            </div>
            <!-- 用户类型 -->
